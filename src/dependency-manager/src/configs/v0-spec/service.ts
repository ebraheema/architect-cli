...
import { ParameterValue, ServiceApiSpec, ServiceConfig, ServiceDatastore, ServiceDebugOptions, ServiceEventNotifications, ServiceEventSubscriptions, ServiceInterfaceSpec, ServiceParameter, VolumeSpec } from '../service';
...
export class ServiceSpecV1 extends ServiceConfig {
  ...
  getDebugOptions(): ServiceDebugOptions | undefined {
    return typeof this.debug === 'string'
      ? { command: this.debug }
      : this.debug;
  }
